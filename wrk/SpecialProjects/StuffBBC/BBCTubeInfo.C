...
void BBCTubeInfo()
{
  ...
  tg_xy->GetXaxis()->SetTitle("BBC tube x (mm)");
  tg_xy->GetYaxis()->SetTitle("BBC tube y (mm)");
  tg_xy->Draw("ap");
  TEllipse* el0 = new TEllipse(0,0,radius_layer_inner,radius_layer_inner);
  el0->SetFillStyle(0);
  el0->SetLineColor(kRed);
  el0->Draw();
  TEllipse* el1 = new TEllipse(0,0,radius_layer_middle,radius_layer_middle);
  el1->SetFillStyle(0);
  el1->SetLineColor(kGreen+2);
  el1->Draw();
  TEllipse* el2 = new TEllipse(0,0,radius_layer_outer,radius_layer_outer);
  el2->SetFillStyle(0);
  el2->SetLineColor(kBlue);
  el2->Draw();
  TEllipse* el3 = new TEllipse(0,0,radius_layer_innermiddle,radius_layer_innermiddle);
  el3->SetFillStyle(0);
  el3->SetLineColor(kOrange+2);
  el3->Draw();
  TEllipse* el4 = new TEllipse(0,0,radius_layer_outermiddle,radius_layer_outermiddle);
  el4->SetFillStyle(0);
  el4->SetLineColor(kMagenta+2);
  el4->Draw();
