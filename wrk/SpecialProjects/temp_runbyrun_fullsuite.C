...
void makemult_new(int energy)
{
  ...
  if ( line ) delete line;
  line = new TLine(array_run[0]-100,cut_cnt,array_run[counter-1]+100,cut_cnt);
  line->SetLineStyle(2);
  line->SetLineWidth(2);
  line->Draw();
  if ( aline ) delete aline;
  aline = new TLine(array_run[0]-100,cut_cnt_above,array_run[counter-1]+100,cut_cnt_above);
  aline->SetLineStyle(2);
  aline->SetLineWidth(2);
  aline->Draw();
  if ( mline ) delete mline;
  mline = new TLine(array_run[0]-100,mean_cnt,array_run[counter-1]+100,mean_cnt);
  mline->SetLineStyle(2);
  mline->SetLineWidth(2);
  mline->Draw();
  ...
  if ( line ) delete line;
  line = new TLine(array_run[0]-100,cut_bbc,array_run[counter-1]+100,cut_bbc);
  line->SetLineStyle(2);
  line->SetLineWidth(2);
  line->Draw();
  line->Draw();
  if ( aline ) delete aline;
  aline = new TLine(array_run[0]-100,cut_bbc_above,array_run[counter-1]+100,cut_bbc_above);
  aline->SetLineStyle(2);
  aline->SetLineWidth(2);
  aline->Draw();
  if ( mline ) delete mline;
  mline = new TLine(array_run[0]-100,mean_bbc,array_run[counter-1]+100,mean_bbc);
  mline->SetLineStyle(2);
  mline->SetLineWidth(2);
  mline->Draw();
  ...
  if ( line ) delete line;
  line = new TLine(array_run[0]-100,cut_fxt,array_run[counter-1]+100,cut_fxt);
  line->SetLineStyle(2);
  line->SetLineWidth(2);
  line->Draw();
  if ( aline ) delete aline;
  aline = new TLine(array_run[0]-100,cut_fxt_above,array_run[counter-1]+100,cut_fxt_above);
  aline->SetLineStyle(2);
  aline->SetLineWidth(2);
  aline->Draw();
  if ( mline ) delete mline;
  mline = new TLine(array_run[0]-100,mean_fxt,array_run[counter-1]+100,mean_fxt);
  mline->SetLineStyle(2);
  mline->SetLineWidth(2);
  mline->Draw();
  ...
  if ( line ) delete line;
  line = new TLine(array_run[0]-100,cut_fxc,array_run[counter-1]+100,cut_fxc);
  line->SetLineStyle(2);
  line->SetLineWidth(2);
  line->Draw();
  if ( aline ) delete aline;
  aline = new TLine(array_run[0]-100,cut_fxc_above,array_run[counter-1]+100,cut_fxc_above);
  aline->SetLineStyle(2);
  aline->SetLineWidth(2);
  aline->Draw();
  if ( mline ) delete mline;
  mline = new TLine(array_run[0]-100,mean_fxc,array_run[counter-1]+100,mean_fxc);
  mline->SetLineStyle(2);
  mline->SetLineWidth(2);
  mline->Draw();
