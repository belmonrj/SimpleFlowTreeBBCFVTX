  ...
  for ( int ievt = 0; ievt < nentries; ++ievt )
    {
      ...
      if ( centrality > -1 )
        {
          if ( energyflag == 200 && centrality <= 5  ) is_central = true;
          if ( energyflag == 62  && centrality <= 10 ) is_central = true;
          if ( energyflag == 20  && centrality <= 20 ) is_central = true;
          if ( energyflag == 39  && centrality <= 20 ) is_central = true;
        }
