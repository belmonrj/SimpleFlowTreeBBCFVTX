...
// itr 0
  float qy2_offset_fvtxsl[4][4][6] =
  {
    // 200 GeV
    {
      { -0.0126, -0.0175, -0.0178, -0.0309, -0.0600, -0.1197}, // layer 0
      { +0.0019, +0.0059, +0.0075, +0.0094, +0.0096, +0.0154}, // layer 1
      { +0.0010, +0.0074, +0.0058, -0.0019, -0.0035, -0.0165}, // layer 2
      { +0.0032, +0.0120, +0.0104, +0.0074, +0.0080, +0.0224}, // layer 3
    },
    // 62 GeV
    {
      { -0.0169, -0.0233, -0.0252, -0.0451, -0.0667, -0.1251}, // layer 0
      { +0.0071, +0.0052, +0.0053, +0.0057, +0.0107, +0.0149}, // layer 1
      { +0.0014, -0.0012, -0.0031, -0.0047, -0.0132, -0.0319}, // layer 2
      { +0.0044, +0.0048, +0.0021, +0.0035, +0.0081, +0.0162}, // layer 3
    },
    // 39 GeV
    {
      { -0.0148, -0.0178, -0.0261, -0.0366, -0.0476, +0.0000}, // layer 0
      { +0.0086, +0.0080, +0.0078, +0.0085, +0.0124, +0.0000}, // layer 1
      { +0.0041, +0.0015, +0.0024, -0.0016, -0.0013, +0.0000}, // layer 2
      { -0.0001, -0.0012, -0.0034, -0.0031, -0.0084, +0.0000}, // layer 3
    },
    // 20 GeV
    {
      { -0.0298, -0.0227, -0.0432, -0.0229, +0.0000, +0.0000}, // layer 0
      { +0.0032, +0.0066, +0.0153, -0.0370, +0.0000, +0.0000}, // layer 1
      { -0.0033, -0.0003, -0.0057, -0.0511, +0.0000, +0.0000}, // layer 2
      { -0.0030, +0.0051, +0.0089, -0.0247, +0.0000, +0.0000}, // layer 3
    },
  };
