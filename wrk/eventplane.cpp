...
void flatten(int runNumber, int rp_recal_pass)
{
  ...
  float qy2_offset_fvtxsl[4][4][6] =
  {
    // 200 GeV
    {
      { +0.0000, +0.0000, +0.0000, +0.0000, +0.0000, +0.0000}, // layer 0
      { +0.0000, +0.0000, +0.0000, +0.0000, +0.0000, +0.0000}, // layer 1
      { +0.0000, +0.0000, +0.0000, +0.0000, +0.0000, +0.0000}, // layer 2
      { +0.0000, +0.0000, +0.0000, +0.0000, +0.0000, +0.0000}, // layer 3
    },
    // 62 GeV
    {
      { +0.0000, +0.0000, +0.0000, +0.0000, +0.0000, +0.0000}, // layer 0
