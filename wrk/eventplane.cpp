...
void flatten(int runNumber, int rp_recal_pass)
{
  ...
  // {
  //   { -0.0033, -0.0145, -0.0042, -0.0013, -0.0127, -0.0056}, //200 GeV
  //   { -0.0005, -0.0019, -0.0041, -0.0062, -0.0032, -0.0013}, //62 GeV
  //   { -0.0047, -0.0057, -0.0034, -0.0015, -0.0043, -0.0000}, //39 GeV
  //   { -0.0022, -0.0162, -0.0051, -0.0451, -0.0000, -0.0000}, //20 GeV
  // };
  //---
  ...
  // {
  //   { 0.0019, -0.0366,  0.0121,  0.0220,  0.0550,  0.1582}, // 200 GeV
  //   { 0.0070,  0.0111,  0.0164,  0.0363,  0.0671,  0.1334}, // 62 GeV
  //   { 0.0112,  0.0090,  0.0230,  0.0291,  0.0293,  0.0000}, // 39 GeV
