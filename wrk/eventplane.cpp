...
// itr 1
  ...
  {
    { -0.0004, -0.0057, +0.0031, +0.0168, +0.0449, +0.1355 }, // 200 GeV
    { +0.0056, +0.0088, +0.0107, +0.0295, +0.0556, +0.1226 }, // 62 GeV
    { +0.0070, +0.0071, +0.0189, +0.0257, +0.0325, +0.0000 }, // 39 GeV
    { -0.0051, +0.0082, +0.0183, -0.0145, +0.0000, +0.0000 }, // 20 GeV
  };
  //--
...
// itr 1
  ...
  {
    { +0.0049, -0.0033, +0.0068, +0.0085, -0.0087, -0.0010 }, // 200 GeV
    { +0.0017, +0.0001, -0.0016, +0.0031, -0.0020, -0.0020 }, // 62 GeV
    { +0.0009, +0.0005, +0.0017, +0.0014, +0.0016, +0.0000 }, // 39 GeV
    { +0.0154, +0.0097, -0.0065, -0.0735, +0.0000, +0.0000 }, // 20 GeV
  };
  //--
...
// 200 GeV
    {
      { +0.0228, +0.0294, +0.0320, +0.0595, +0.1109, +0.2466}, // layer 0
      { -0.0045, -0.0121, -0.0132, -0.0087, -0.0015, +0.0118}, // layer 1
      { -0.0051, -0.0071, -0.0036, -0.0018, +0.0039, +0.0191}, // layer 2
      { -0.0078, -0.0095, -0.0106, -0.0030, -0.0001, +0.0214}, // layer 3
    },
// 62 GeV
    {
      { +0.0316, +0.0353, +0.0461, +0.0741, +0.1226, +0.2431}, // layer 0
      { -0.0064, -0.0064, -0.0090, +0.0010, +0.0016, +0.0221}, // layer 1
      { -0.0001, -0.0005, +0.0004, +0.0034, +0.0061, +0.0189}, // layer 2
      { -0.0049, -0.0028, -0.0029, +0.0010, -0.0016, +0.0015}, // layer 3
    },
// 39 GeV
    {
      { +0.0302, +0.0329, +0.0515, +0.0682, +0.0878, +0.0000}, // layer 0
      { -0.0026, -0.0049, -0.0036, -0.0001, -0.0043, +0.0000}, // layer 1
      { +0.0009, +0.0010, +0.0055, +0.0055, +0.0045, +0.0000}, // layer 2
      { -0.0045, -0.0059, -0.0023, +0.0003, -0.0016, +0.0000}, // layer 3
    },
// 20 GeV
    {
      { +0.0201, +0.0445, +0.0622, +0.0679, +0.0000, +0.0000}, // layer 0
      { -0.0135, -0.0080, -0.0059, -0.0794, +0.0000, +0.0000}, // layer 1
      { +0.0022, -0.0010, +0.0024, -0.0159, +0.0000, +0.0000}, // layer 2
      { -0.0154, -0.0051, -0.0126, -0.0030, +0.0000, +0.0000}, // layer 3
    },
  };
