...
// 200 GeV
    {
      { -0.0220, -0.0306, -0.0310, -0.0539, -0.1041, -0.2050}, // layer 0
      { +0.0033, +0.0103, +0.0131, +0.0165, +0.0168, +0.0271}, // layer 1
      { +0.0018, +0.0130, +0.0102, -0.0033, -0.0061, -0.0288}, // layer 2
      { +0.0057, +0.0211, +0.0182, +0.0129, +0.0140, +0.0393}, // layer 3
    },
// 62 GeV
    {
      { -0.0294, -0.0407, -0.0440, -0.0785, -0.1156, -0.2137}, // layer 0
      { +0.0124, +0.0090, +0.0092, +0.0101, +0.0187, +0.0262}, // layer 1
      { +0.0025, -0.0022, -0.0054, -0.0082, -0.0231, -0.0562}, // layer 2
      { +0.0077, +0.0083, +0.0037, +0.0062, +0.0143, +0.0286}, // layer 3
    },
// 39 GeV
    {
      { -0.0258, -0.0310, -0.0456, -0.0638, -0.0826, +0.0000}, // layer 0
      { +0.0151, +0.0140, +0.0136, +0.0149, +0.0217, +0.0000}, // layer 1
      { +0.0072, +0.0026, +0.0043, -0.0029, -0.0024, +0.0000}, // layer 2
      { -0.0002, -0.0021, -0.0060, -0.0054, -0.0148, +0.0000}, // layer 3
    },
// 20 GeV
    {
      { -0.0521, -0.0392, -0.0750, -0.0380, +0.0000, +0.0000}, // layer 0
      { +0.0056, +0.0116, +0.0268, -0.0657, +0.0000, +0.0000}, // layer 1
      { -0.0058, -0.0006, -0.0099, -0.0894, +0.0000, +0.0000}, // layer 2
      { -0.0053, +0.0090, +0.0154, -0.0429, +0.0000, +0.0000}, // layer 3
    },
  };
