...
// 200 GeV
    {
      { -0.0236, -0.0327, -0.0332, -0.0576, -0.1112, -0.2178}, // layer 0
      { +0.0036, +0.0111, +0.0141, +0.0177, +0.0180, +0.0290}, // layer 1
      { +0.0020, +0.0139, +0.0109, -0.0035, -0.0065, -0.0309}, // layer 2
      { +0.0060, +0.0225, +0.0195, +0.0138, +0.0150, +0.0421}, // layer 3
    },
// 62 GeV
    {
      { -0.0315, -0.0436, -0.0471, -0.0838, -0.1234, -0.2269}, // layer 0
      { +0.0133, +0.0097, +0.0098, +0.0108, +0.0201, +0.0280}, // layer 1
      { +0.0027, -0.0023, -0.0058, -0.0088, -0.0248, -0.0603}, // layer 2
      { +0.0082, +0.0089, +0.0039, +0.0067, +0.0152, +0.0307}, // layer 3
    },
// 39 GeV
    {
      { -0.0277, -0.0332, -0.0488, -0.0683, -0.0883, +0.0000}, // layer 0
      { +0.0162, +0.0149, +0.0146, +0.0160, +0.0233, +0.0000}, // layer 1
      { +0.0077, +0.0028, +0.0045, -0.0031, -0.0025, +0.0000}, // layer 2
      { -0.0002, -0.0023, -0.0064, -0.0058, -0.0158, +0.0000}, // layer 3
    },
// 20 GeV
    {
      { -0.0558, -0.0420, -0.0802, -0.0401, +0.0000, +0.0000}, // layer 0
      { +0.0059, +0.0125, +0.0288, -0.0706, +0.0000, +0.0000}, // layer 1
      { -0.0062, -0.0006, -0.0107, -0.0958, +0.0000, +0.0000}, // layer 2
      { -0.0057, +0.0097, +0.0165, -0.0458, +0.0000, +0.0000}, // layer 3
    },
  };
  //---
  //---
