...
// itr 1
  float qy2_offset_fvtxsl[4][4][6] =
  {
    // 200 GeV
    {
      { -0.0189, -0.0262, -0.0266, -0.0463, -0.0896, -0.1776}, // layer 0
      { +0.0029, +0.0088, +0.0113, +0.0142, +0.0144, +0.0232}, // layer 1
      { +0.0016, +0.0111, +0.0088, -0.0028, -0.0052, -0.0247}, // layer 2
      { +0.0048, +0.0180, +0.0156, +0.0111, +0.0120, +0.0336}, // layer 3
    },
    // 62 GeV
    {
      { -0.0252, -0.0349, -0.0377, -0.0674, -0.0995, -0.1854}, // layer 0
      { +0.0106, +0.0077, +0.0079, +0.0086, +0.0160, +0.0224}, // layer 1
      { +0.0022, -0.0018, -0.0046, -0.0070, -0.0198, -0.0481}, // layer 2
      { +0.0065, +0.0071, +0.0031, +0.0053, +0.0122, +0.0245}, // layer 3
    },
    // 39 GeV
    {
      { -0.0222, -0.0266, -0.0390, -0.0548, -0.0710, +0.0000}, // layer 0
      { +0.0130, +0.0119, +0.0116, +0.0128, +0.0186, +0.0000}, // layer 1
      { +0.0062, +0.0022, +0.0036, -0.0025, -0.0020, +0.0000}, // layer 2
      { -0.0002, -0.0018, -0.0051, -0.0047, -0.0127, +0.0000}, // layer 3
    },
    // 20 GeV
    {
      { -0.0447, -0.0338, -0.0646, -0.0333, +0.0000, +0.0000}, // layer 0
      { +0.0047, +0.0100, +0.0230, -0.0559, +0.0000, +0.0000}, // layer 1
      { -0.0049, -0.0005, -0.0085, -0.0767, +0.0000, +0.0000}, // layer 2
      { -0.0045, +0.0077, +0.0132, -0.0369, +0.0000, +0.0000}, // layer 3
    },
  };
