...
void doit(int handle, int harmonic)
{
  ...
  c1->Print(Form("FigsTwo/corr_os_bbcs_d%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_bbcs_d%d2_%d.pdf",harmonic,handle));
  ...
  tlmeth3->SetNDC();
  tlmeth3->Draw();
  c1->Print(Form("FigsTwo/corr_os_bbcs_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_bbcs_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/corr_os_fvtxs_d%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_fvtxs_d%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/corr_os_fvtxs_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_fvtxs_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/corr_os_fvtxn_d%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_fvtxn_d%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/corr_os_fvtxn_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/corr_os_fvtxn_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/newref_os_bbcs_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/newref_os_bbcs_v%d2_%d.pdf",harmonic,handle));
  ...
  tlmeth->DrawLatex(tlx2,tly2,Form("scalar product with FVTXS"));
  tlmeth3->DrawLatex(tlx3,tly3,Form("reference flow using BBCS, FVTXS, FVTXN"));
  c1->Print(Form("FigsTwo/newref_os_fvtxs_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/newref_os_fvtxs_v%d2_%d.pdf",harmonic,handle));
  ...
  tlmeth->DrawLatex(tlx2,tly2,Form("scalar product with FVTXN"));
  tlmeth3->DrawLatex(tlx3,tly3,Form("reference flow using BBCS, FVTXS, FVTXN"));
  c1->Print(Form("FigsTwo/newref_os_fvtxn_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/newref_os_fvtxn_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/threesp_os_bbcsfvtxs_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/threesp_os_bbcsfvtxs_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/threesp_os_bbcsfvtxn_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/threesp_os_bbcsfvtxn_v%d2_%d.pdf",harmonic,handle));
  ...
  c1->Print(Form("FigsTwo/threesp_os_fvtxsfvtxn_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/threesp_os_fvtxsfvtxn_v%d2_%d.pdf",harmonic,handle));
  ...
  leg->SetFillStyle(0);
  leg->Draw();
  c1->Print(Form("FigsTwo/threesp_os_compare_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/threesp_os_compare_v%d2_%d.pdf",harmonic,handle));
  ...
  leg->SetFillStyle(0);
  leg->Draw();
  c1->Print(Form("FigsTwo/nr3c_os_compare_v%d2_%d.png",harmonic,handle));
  c1->Print(Form("FigsTwo/nr3c_os_compare_v%d2_%d.pdf",harmonic,handle));
