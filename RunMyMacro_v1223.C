...
void RunMyMacro_v1223(const char *modulemacro = "Run_SimpleFlowTreeBBCFVTX.C",  // your anataxi macro name
                      ...
                      //const char *system      = "Run15pAl200MBPro104") // system type
{
  ...
  if (strcmp(system, "Run3dAu200Electron") == 0)
  ...
  else if (strcmp(system, "Run14AuAu15CAMinBias") == 0)
    {
      ...
      dst_mpcfile = "DST_EVE_MB_run14AuAu_15GeV_CA_noSVX_pro100-0000405030-9000.root";
      pwg_included = true;
    }
  else
    {
